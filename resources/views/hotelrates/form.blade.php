...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'hotelrates/save/'.SiteHelpers::encryptID($row['hotelrateid']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelratesFormAjax')) !!}
			<div class="col-md-12">
            ...
            {!! Form::hidden('hotelID', app('request')->input('hotelID') ) !!}					
					...
					@foreach($row['images'] as $files)
                        ...
                        <span class="pull-left removeMultiFiles " rel="cr-<?php echo $cr;?>" url="/uploads/images/{{$files}}">
                            ...
                            {!! SiteHelpers::showUploadedFile($files,'/uploads/images/') !!}
