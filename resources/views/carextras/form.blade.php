...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'carextras/save/'.SiteHelpers::encryptID($row['carsextrasID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'carextrasFormAjax')) !!}
			<div class="col-md-12">
