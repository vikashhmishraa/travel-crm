...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'airlines/save/'.SiteHelpers::encryptID($row['airlineID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'airlinesFormAjax')) !!}
			<div class="col-md-12">
