...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'parkingandadmissionfees/save/'.SiteHelpers::encryptID($row['siteID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'parkingandadmissionfeesFormAjax')) !!}
			<div class="col-md-12">
