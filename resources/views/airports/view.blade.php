...
@endif	
		...
		<table class="table  table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Airport Name', (isset($fields['airport_name']['language'])? $fields['airport_name']['language'] : array())) }}</td>
						<td>{{ $row->airport_name}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Country', (isset($fields['countryID']['language'])? $fields['countryID']['language'] : array())) }}</td>
						<td>{{ SiteHelpers::formatLookUp($row->countryID,'countryID','1:def_country:countryID:country_name') }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('City', (isset($fields['cityID']['language'])? $fields['cityID']['language'] : array())) }}</td>
