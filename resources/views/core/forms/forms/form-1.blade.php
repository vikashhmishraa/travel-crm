...
<div class="form-group  " >
		...
		<div class="form-group  " >
                ...
                <input type="text" class="form-control" disabled name="tourname" value="{!! SiteHelpers::formatLookUp(app('request')->input('tourID'),'tour_name','1:tours:tourID:tour_name') !!}" required="false">
		</div>

		<div class="form-group  " >
					<label for="ipt" class="  "> Tour Code  </label>
                <input type="text" class="form-control" disabled name="tourcode" value="{!! SiteHelpers::formatLookUp(app('request')->input('tourdateID'),'tour_code','1:tour_date:tourdateID:tour_code') !!}" required="false">

		</div>
		<div class="form-group  " >
					<label for="ipt" class="  "> Tour Date  </label>
                <input type="text" class="form-control" disabled name="tourcode" value="{!! SiteHelpers::formatLookUp(app('request')->input('tourdateID'),'start','1:tour_date:tourdateID:start') !!}" required="false">
		</div>
