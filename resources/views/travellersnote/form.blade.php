...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'travellersnote/save/'.SiteHelpers::encryptID($row['travellers_noteID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'travellersnoteFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{Lang::get('core.travellersnote')}}</legend>
				{!! Form::hidden('travellers_noteID', $row['travellers_noteID']) !!}
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("travellersnote/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#travellersnoteFormAjax'); 
	form.parsley();
