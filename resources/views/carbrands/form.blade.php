...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'carbrands/save/'.SiteHelpers::encryptID($row['carbrandID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'carbrandsFormAjax')) !!}
			<div class="col-md-12">
