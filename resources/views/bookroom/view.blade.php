...
@endif	
		...
		<table class="table  table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('RoomID', (isset($fields['roomID']['language'])? $fields['roomID']['language'] : array())) }}</strong></td>
						<td>{{ $row->roomID}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Room Type', (isset($fields['roomtype']['language'])? $fields['roomtype']['language'] : array())) }}</strong></td>
						<td>{!! SiteHelpers::formatRows($row->roomtype,$fields['roomtype'],$row ) !!} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('BookingID', (isset($fields['bookingID']['language'])? $fields['bookingID']['language'] : array())) }}</strong></td>
						<td>{{ $row->bookingID}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Travellers', (isset($fields['travellers']['language'])? $fields['travellers']['language'] : array())) }}</strong></td>
