...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'hotelsnote/save/'.SiteHelpers::encryptID($row['hotel_noteID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelsnoteFormAjax')) !!}
			<div class="col-md-12">
