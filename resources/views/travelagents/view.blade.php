...
<h3 class="text-center">{!! SiteHelpers::formatRows($row->agent_logo,$fields['agent_logo'],$row ) !!} </h3>
            ...
            <div class="tab-content">
             ...
             @foreach($agent as $ag)
                <tr>
                  ...
                  <td>{{ $ag['phone'] }}</td>
                  <td>{{ $ag['location'] }}</td>
                  <td>{!! GeneralStatus::Status($ag['status']) !!}</td>
            ...
            <table id="notes" class="table table-striped">
             ...
             @foreach($note as $nt)
                <tr>
                  ...
                  <td>{{ $nt['title'] }}</td>
                  <td>{{ $nt['note'] }}</td>
                  <td>{{ SiteHelpers::TarihFormat($nt['created_at'])}}</td>
                  <td>@if($access['is_remove'] =='1')
