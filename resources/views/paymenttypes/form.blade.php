...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'paymenttypes/save/'.SiteHelpers::encryptID($row['paymenttypeID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'paymenttypesFormAjax')) !!}
			<div class="col-md-12">
