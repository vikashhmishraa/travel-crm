...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'tourdetail/save/'.SiteHelpers::encryptID($row['tourdetailID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'tourdetailFormAjax')) !!}
			<div class="col-md-12">
                ...
                {!! Form::hidden('tourID', app('request')->input('tourID') ) !!}										
						...
						required     class='form-control ' /> 
                            ...
                            <div class="form-group  " >
										...
										<div class="col-md-6">
										<label for="Country" class=" control-label">{{ SiteHelpers::formatLookUp( app('request')->input('country'),'countryID','1:def_country:countryID:country_name') }}</label>
										 </div> 
										 <div class="col-md-2">
