...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'commentscheck/save/'.SiteHelpers::encryptID($row['commentID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'commentscheckFormAjax')) !!}
			<div class="col-md-12">
