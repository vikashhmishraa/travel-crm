        ...
        <div class="theiaStickySidebar">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h3 class="profile-username text-center"><a href="{{ url('travellers/show/'.$row->travellerID) }}" target="_blank"> {{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:nameandsurname') }}</a></h3>
            ...
            <div class="box-body">
             ...
             @foreach($rms as $rs)
                <tr>
                  ...
                  <td class="pull-right">{!! BookingStatus::Status($rs['status']) !!}@if($access['is_edit'] =='1')
            ...
            <div class="box-body">
             ...
             @foreach($trs as $ts)
                ...
                <td>{{ date("".CNF_DATE."",strtotime(SiteHelpers::formatLookUp($ts['tourdateID'],'tourdateID','1:tour_date:tourdateID:end'))) }}</td>
                  <td  class="pull-right">{!! BookingStatus::Status($ts['status']) !!}
                      @if($access['is_edit'] =='1')
