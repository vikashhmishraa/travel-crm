...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'hotelcategories/save/'.SiteHelpers::encryptID($row['hotelcategoryID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelcategoriesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.hotelcategories') }}</legend>
				{!! Form::hidden('hotelcategoryID', $row['hotelcategoryID']) !!}					
									  <div class="form-group  " >
										<label for="Category Name" class=" control-label col-md-4 text-left"> {{ Lang::get('core.category') }} <span class="asterix"> * </span></label>
										<div class="col-md-6">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("hotelcategories/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#hotelcategoriesFormAjax'); 
	form.parsley();
