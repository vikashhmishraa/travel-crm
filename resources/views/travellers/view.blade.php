                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b>{{Lang::get('core.passportcountry')}}</b><a class="pull-right">{{ SiteHelpers::formatLookUp($row->passportcountry,'passportcountry','1:def_country:countryID:country_name') }}</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                ...
                <table id="payments" class="table  table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ SiteHelpers::formatLookUp($pt['payment_type'],'paymenttypeID','1:def_payment_types:paymenttypeID:payment_type') }}</td>
                            <td>{{ $pt['notes'] }}</td>
            ...
            <div class="tab-pane" id="tab_5">
                <table id="notes" class="table  table-striped">
                    ...
                    <tbody>
                        @foreach($file as $fl)
                        <tr>
                            <td>{!! SiteHelpers::showUploadedFile($fl['file'],'/uploads/files/') !!}</td>
