...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'vehicletypes/save/'.SiteHelpers::encryptID($row['vehicleID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'vehicletypesFormAjax')) !!}
			<div class="col-md-12">
