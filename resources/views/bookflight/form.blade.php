...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'bookflight/save/'.SiteHelpers::encryptID($row['bookflightID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'bookflightFormAjax')) !!}
			<div class="col-md-12">
