...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'cities/save/'.SiteHelpers::encryptID($row['cityID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'citiesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.cities') }}</legend>
				{!! Form::hidden('cityID', $row['cityID']) !!}					
                            ...
                            <div class="form-group  " >
										<label for="City Name" class=" control-label col-md-4 text-left"> {{ Lang::get('core.city') }} <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  <input  type='text' name='city_name' id='city_name' value='{{ $row['city_name'] }}' 
...
$(document).ready(function() { 
		...
		$("#countryID").jCombo("{!! url('cities/comboselect?filter=def_country:countryID:country_name') !!}",
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("cities/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
