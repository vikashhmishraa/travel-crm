...
@endif	
        ...
        @endif
			{!! Form::open(array('url'=>'payments/save/'.SiteHelpers::encryptID($row['invoicePaymentID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'paymentsFormAjax')) !!}
			<div class="col-md-12">
            ...
            {{ SiteHelpers::formatLookUp( app('request')->input('travellerID'),'travellerID','1:travellers:travellerID:nameandsurname') }}                                       </label>
