...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'groupsales/save/'.SiteHelpers::encryptID($row['saleID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'groupsalesFormAjax')) !!}
			<div class="col-md-12">
