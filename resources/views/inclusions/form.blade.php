...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'inclusions/save/'.SiteHelpers::encryptID($row['inclusionID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'inclusionsFormAjax')) !!}
			<div class="col-md-12">
