...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'travelagentnote/save/'.SiteHelpers::encryptID($row['travelagentnoteID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'travelagentnoteFormAjax')) !!}
			<div class="col-md-12">
