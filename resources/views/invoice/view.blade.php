...
<php></php>
    <section class="invoice">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          <address>
            <strong>{{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:nameandsurname') }}</strong><br>
            {{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:address') }} 
            {{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:city') }} 
            ...
            {{Lang::get('core.phone')}}: {{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:phone') }}<br>
            {{Lang::get('core.email')}}: {{ SiteHelpers::formatLookUp($row->travellerID,'travellerID','1:travellers:travellerID:email') }}
          </address>
        </div>
        <div class="col-sm-4 invoice-col">
          <h2>{{Lang::get('core.invoiceno')}}: {{ $row->invoiceID}}</h2>
          <b>{{Lang::get('core.bookingno')}}: {{ SiteHelpers::formatLookUp($row->bookingID,'bookingsID','1:bookings:bookingsID:bookingno') }}</b><br>
