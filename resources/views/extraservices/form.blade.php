...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'extraservices/save/'.SiteHelpers::encryptID($row['extraserviceID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'extraservicesFormAjax')) !!}
			<div class="col-md-12">
