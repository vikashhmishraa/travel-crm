<nav class="breadcrumb"> <a class="breadcrumb-item" href="{{ url('') }}">Home</a> <a class="breadcrumb-item" href="{{ url('trips') }}">Tours</a> <span class="breadcrumb-item active"> {{ isset($_GET['cat']) ? SiteHelpers::formatLookUp($_GET['cat'],'tourcategoriesID','1:def_tour_categories:tourcategoriesID:tourcategoryname') : '' }}
</span> </nav>
