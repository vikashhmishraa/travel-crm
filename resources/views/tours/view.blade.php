    ...
    <div class="col-md-3">
        ...
        <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <div class="m-t-xl">
                            <h2 class="text-green">{!! SiteHelpers::Status2($row->status) !!}</h2>
                        </div>
                    </div>
                </div>
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <div class="m-t-xl">
                            <h2 class="text-green">{!! SiteHelpers::Departs2($row->departs) !!}</h2>
                        </div>
                    </div>
                </div>
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <div class="m-t-xl">
                            <p class="text-green">{!! SiteHelpers::showPaymentOptions2($row->payment_options) !!}</p>
                        </div>
                    </div>
                </div>
...
<td>                 {!! $dt['description'] !!} 
            ...
            @endif 			
            <br>
            <strong>{{ Lang::get('core.overnight') }}:</strong> {{ SiteHelpers::formatLookUp($dt['hotelID'],'hotelID','1:hotels:hotelID:hotel_name') }}, {{ SiteHelpers::formatLookUp($dt['cityID'],'cityID','1:def_city:cityID:city_name') }}<br>
