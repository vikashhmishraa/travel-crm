...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'hotelfacilities/save/'.SiteHelpers::encryptID($row['hotelfacilityID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelfacilitiesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend>{{ Lang::get('core.hotelfacilities') }}</legend>
				{!! Form::hidden('hotelfacilityID', $row['hotelfacilityID']) !!}					
									  <div class="form-group  " >
										<label for="Facility" class=" control-label col-md-4 text-left"> {{ Lang::get('core.facility') }} <span class="asterix"> * </span></label>
										<div class="col-md-6">
						...
						required     class='form-control ' /> 
									  ...
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='iconID' id='iconID' value='{{ $row['iconID'] }}' 
						     class='form-control ' /> 
										 </div> 
										 <div class="col-md-2">
										 	            <a href="javascript:void(0)" onclick="MmbModal('{{ url('core/template/icons') }}','FontAwesome Icons')">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("hotelfacilities/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#hotelfacilitiesFormAjax'); 
	form.parsley();
