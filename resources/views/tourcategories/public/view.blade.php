	...
	<div class="table-responsive" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Tour Category', (isset($fields['tourcategoryname']['language'])? $fields['tourcategoryname']['language'] : array())) }}</strong></td>
