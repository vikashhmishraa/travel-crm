...
<div class="box box-primary">
	...
	<div class="box-body"> 	
	 ...
	 <?php echo Form::open(array('url'=>'tourcategories/delete/', 'class'=>'form-horizontal' ,'id' =>'MmbTable'  ,'data-parsley-validate'=>'' )) ;?>
			...
			<tr id="form-0" >
			  ...
			  @endif        
                ...
                <tr class="editable" id="form-{{ $row->tourcategoriesID }}">
					...
					<td><a href="javascript:void(0)" class="expandable" rel="#row-{{ $row->tourcategoriesID }}" data-url="{{ url('tourcategories/show/'.$id) }}"><i class="fa fa-plus fa-2x" ></i></a></td>								
					@endif		
				 <td data-values="action" data-key="<?php echo $row->tourcategoriesID ;?>"  >
					{!! AjaxHelpers::buttonAction('tourcategories',$access,$id ,$setting) !!}
