...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'tourcategories/save/'.SiteHelpers::encryptID($row['tourcategoriesID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'tourcategoriesFormAjax')) !!}
			<div class="col-md-12">
