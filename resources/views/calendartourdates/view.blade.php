		...
		<table class="table  table-bordered" >
			<tbody>	
					...
					<tr>
						...
						<td>{!! SiteHelpers::Featured($row->featured) !!} </td>
					...
					<tr>
						...
						<td>{{ SiteHelpers::formatLookUp($row->tourID,'tourID','1:tours:tourID:tour_name') }} </td>
					...
					<tr>
						...
						<td>{!! SiteHelpers::Definite_departure($row->definite_departure) !!} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ Lang::get('core.start') }}</strong></td>
						<td>{{ SiteHelpers::TarihFormat($row->start)}} </td>
					...
					<tr>
						...
						<td>{{ SiteHelpers::formatLookUp($row->guideID,'guideID','1:guides:guideID:name') }} </td>
					...
					<tr>
						...
						<td>{{ $row->cost_single}} {{ SiteHelpers::formatLookUp($row->currencyID,'currencyID','1:def_currency:currencyID:symbol|currency_name') }}</td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ Lang::get('core.doubleroom') }}</strong></td>
						<td>{{ $row->cost_double}} {{ SiteHelpers::formatLookUp($row->currencyID,'currencyID','1:def_currency:currencyID:symbol|currency_name') }}</td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ Lang::get('core.tripleroom') }}</strong></td>
						<td>{{ $row->cost_triple}} {{ SiteHelpers::formatLookUp($row->currencyID,'currencyID','1:def_currency:currencyID:symbol|currency_name') }}</td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ Lang::get('core.child') }}</strong></td>
						<td>{{ $row->cost_child}} {{ SiteHelpers::formatLookUp($row->currencyID,'currencyID','1:def_currency:currencyID:symbol|currency_name') }}</td>
