		...
		<div class="table-responsive" >  
			<table class="table table-striped table-bordered" >
				<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Group Size', (isset($fields['total_capacity']['language'])? $fields['total_capacity']['language'] : array())) }}</strong></td>
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Available Optionals', (isset($fields['available_optionals']['language'])? $fields['available_optionals']['language'] : array())) }}</strong></td>
						<td>{{ SiteHelpers::formatLookUp($row->available_optionals,'available_optionals','1:def_optional_tours:optionaltourID:optional_tour') }} </td>
