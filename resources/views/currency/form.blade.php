...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'currency/save/'.SiteHelpers::encryptID($row['currencyID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'currencyFormAjax')) !!}
			<div class="col-md-12">
