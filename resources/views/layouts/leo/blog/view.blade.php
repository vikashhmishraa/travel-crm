              ...
              <div class="col-md-11">
                <div class="media-body">
                  ...
                  <ul class="list-inline meta text-muted">
                    <li class="list-inline-item"><i class="fa fa-calendar"></i> {{ SiteHelpers::TarihFormat($row->created)}}</li>
                  </ul>
                  ...
                  <div class="blog-content">
                   ...
                   @if($row->image != NULL)
					...
					@endif	
                    <p class="lead">
					 {!! PostHelpers::formatContent($row->note) !!}</p>
                  </div>
                  <!-- Post tags -->
                ...
                @foreach($comments as $comm)
                  ...
                  <div class="media-body">
                    <ul class="list-inline blog-meta text-muted">
                      <li class="list-inline-item"> {{ SiteHelpers::TarihFormat($comm->posted)}}</li>
                      <li class="list-inline-item"><i class="fa fa-user"></i> <a href="#">{{ ucwords($comm->username) }}</a></li>
                    </ul>
                    <p class="mb-1">{!! PostHelpers::formatContent($comm->comments) !!}</p>
                  </div>
                </li>
                @endforeach
              </ul>
