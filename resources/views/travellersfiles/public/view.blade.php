	...
	<div class="table-responsive" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('TravellerID', (isset($fields['travellerID']['language'])? $fields['travellerID']['language'] : array())) }}</strong></td>
						<td>{{ $row->travellerID}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('File Type', (isset($fields['file_type']['language'])? $fields['file_type']['language'] : array())) }}</strong></td>
						<td>{{ $row->file_type}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('File', (isset($fields['file']['language'])? $fields['file']['language'] : array())) }}</strong></td>
						<td>{{ $row->file}} </td>
