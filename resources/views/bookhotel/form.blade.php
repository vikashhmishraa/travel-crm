...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'bookhotel/save/'.SiteHelpers::encryptID($row['bookhotelID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'bookhotelFormAjax')) !!}
			<div class="col-md-12">
