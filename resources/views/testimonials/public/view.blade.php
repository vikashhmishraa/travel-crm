	...
	<div class="table-responsive" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'><strong>{{ SiteHelpers::activeLang('Testimonial', (isset($fields['testimonial']['language'])? $fields['testimonial']['language'] : array())) }}</strong></td>
