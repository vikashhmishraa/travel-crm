...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'testimonials/save/'.SiteHelpers::encryptID($row['testimonialID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'testimonialsFormAjax')) !!}
			<div class="col-md-12">
