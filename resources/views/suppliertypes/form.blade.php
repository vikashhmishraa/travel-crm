...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'suppliertypes/save/'.SiteHelpers::encryptID($row['suppliertypeID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'suppliertypesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> {{ Lang::get('core.suppliertypes') }}</legend>
				{!! Form::hidden('suppliertypeID', $row['suppliertypeID']) !!}					
									  <div class="form-group  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='supplier_type' id='supplier_type' value='{{ $row['supplier_type'] }}' 
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("suppliertypes/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
	...
	var form = $('#suppliertypesFormAjax'); 
	form.parsley();
