 ...
 <div class="theiaStickySidebar">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h3 class="profile-username text-center"><a href="{{ url('travellers/show/'.$row->UserID) }}" target="_blank">{{ SiteHelpers::formatLookUp($row->UserID,'UserID','1:travellers:travellerID:nameandsurname') }}</a></h3>
                <p class="text-muted text-center">{{ SiteHelpers::formatLookUp($row->UserID,'UserID','1:travellers:travellerID:email') }}</p>
                <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>{{ Lang::get('core.category') }}</b> <a class="pull-right">{{ SiteHelpers::formatLookUp($row->Category,'Category','1:tbl_ticket_category:ticket_category_ID:ticket_category') }}</a>
                </li>
                <li class="list-group-item">
                  <b>{{ Lang::get('core.priority') }}</b> <a class="pull-right 
                         ...
                         @endif">{!! SiteHelpers::formatRows($row->Priority,$fields['Priority'],$row ) !!}</a>
                </li>
                <li class="list-group-item" >
...
<div class="box box-primary ">
    ...
    <ul class="timeline">
                    <li class="time-label">
                  <span class="bg-red">
                    {{ SiteHelpers::TarihFormat($row->createdOn)}}
                  </span>
            </li>
<li>
