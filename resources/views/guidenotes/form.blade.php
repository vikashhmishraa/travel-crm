...
<div class="box box-primary">
	...
	<div class="box-body"> 
@endif	
			{!! Form::open(array('url'=>'guidenotes/save/'.SiteHelpers::encryptID($row['guidenotesID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'guidenotesFormAjax')) !!}
			<div class="col-md-12">
